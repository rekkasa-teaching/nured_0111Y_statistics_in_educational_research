...
# Convert to kindergarten heights (mean ~110cm, sd ~10cm)
set.seed(123)  # for reproducibility

n <- 10000
step <- 10
heights <- rnorm(n, mean = 0, sd = 1) |>
  (\(x) x * 10 + 110)()  # Transform: multiply by 10 and add 110

# Create a data frame
height_data <- tibble::tibble(height = heights)
...
ggplot2::ggplot(height_data, ggplot2::aes(x = height)) +
  ...
  ggplot2::labs(
    title = glue::glue("Τα ύψη { n } παιδιών"),
    x = "Ύψος (σε εκατοστά)",
    y = "Σχετική συχνότητα"
  ) +
